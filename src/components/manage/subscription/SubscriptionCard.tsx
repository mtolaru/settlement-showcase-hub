...
const SubscriptionCard = ({
  ...
  return <div className={`flex items-start gap-4 p-4 ${isCanceled ? 'bg-amber-50' : 'bg-primary-50'} rounded-lg`}>
      ...
      <div className="flex-1">
        ...
        {isCanceled && <div className="mt-2 text-amber-800 font-medium">
